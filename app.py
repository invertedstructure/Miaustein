...
def post_halt_continuation_reason_validation_errors_v0(
    ...
    if set(APPROVED_DRAFTABLE_MOVE_SHAPES_V0) != expected_approved_shapes:
        errors.append("approved_shape_set_not_exactly_expected_five")
...
def _accepted_selected_next_shape_surface_move_phase_closed_v0(
    ...
    return (
        ...
        and state.get("status") == SELECTED_NEXT_SHAPE_SURFACE_OUTCOME_V0
    )
...
def human_selection_required_boundary_draft_record_v0(
    ...
    *,
    ...
    if isinstance(move_registry, list) and HUMAN_SELECTION_REQUIRED_BOUNDARY_MOVE_ID_V0 in move_registry:
        blockers.append("human_selection_required_boundary_move_already_in_move_registry")
    if HUMAN_SELECTION_REQUIRED_BOUNDARY_MOVE_ID_V0 in MOVE_ORDER_V0:
    ...
    if HUMAN_SELECTION_REQUIRED_BOUNDARY_MOVE_ID_V0 in APPROVED_DRAFTABLE_MOVE_SHAPES_V0:
        blockers.append("human_selection_required_boundary_move_already_explicitly_approved")
    if isinstance(typed_declared_moves, list) and HUMAN_SELECTION_REQUIRED_BOUNDARY_MOVE_ID_V0 in typed_declared_moves:
