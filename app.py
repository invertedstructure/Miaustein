...
def _accepted_registered_move_readout_phase_closed_v0(
    ...
    return (
        ...
        and state.get("status") == ACCEPTED_REGISTERED_MOVE_READOUT_OUTCOME_V0
    )
...
def next_selected_missing_move_draft_record_v0(
    ...
    *,
    ...
    if isinstance(move_registry, list) and NEXT_SELECTED_POST_HALT_REASON_MOVE_ID_V0 in move_registry:
        blockers.append("selected_move_already_in_move_registry")
    if NEXT_SELECTED_POST_HALT_REASON_MOVE_ID_V0 in MOVE_ORDER_V0:
        blockers.append("selected_move_already_in_MOVE_ORDER_V0")
    if history_contains:
        blockers.append("selected_move_already_in_history")
    if NEXT_SELECTED_POST_HALT_REASON_MOVE_ID_V0 in APPROVED_DRAFTABLE_MOVE_SHAPES_V0:
