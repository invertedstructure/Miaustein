...
def post_halt_continuation_reason_validation_errors_v0(
    ...
    if set(APPROVED_DRAFTABLE_MOVE_SHAPES_V0) != expected_approved_shapes:
        errors.append("approved_shape_set_not_exactly_expected_four")
...
def _accepted_terminal_reason_specificity_move_phase_closed_v0(
    ...
    return (
        ...
        and state.get("status") == TERMINAL_REASON_SPECIFICITY_OUTCOME_V0
    )
...
def selected_next_shape_surface_draft_record_v0(
    ...
    *,
    ...
    if isinstance(move_registry, list) and SELECTED_NEXT_SHAPE_SURFACE_MOVE_ID_V0 in move_registry:
        blockers.append("selected_next_shape_surface_move_already_in_move_registry")
    if SELECTED_NEXT_SHAPE_SURFACE_MOVE_ID_V0 in MOVE_ORDER_V0:
    ...
    if SELECTED_NEXT_SHAPE_SURFACE_MOVE_ID_V0 in APPROVED_DRAFTABLE_MOVE_SHAPES_V0:
...
def selected_next_shape_surface_draft_verifier_v0(
    ...
    *,
    ...
    if drafted_record.get("move_id") in MOVE_ORDER_V0 or drafted_record.get("synthetic_MOVE_ORDER_V0_contains_move") is True:
